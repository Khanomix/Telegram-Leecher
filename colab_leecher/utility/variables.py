...
class Paths:
    ...
    DEFAULT_HERO =  "/kaggle/working/Telegram-Leecher/custom_thmb.jpg"
    MOUNTED_DRIVE = "/kaggle/input/nimuoo"
    down_path = f"{WORK_PATH}/Downloads"
    temp_dirleech_path = f"{WORK_PATH}/dir_leech_temp"
    mirror_dir = "/kaggle/input/nimuoo"
    ...
    access_token = "/kaggle/working/token.pickle"
